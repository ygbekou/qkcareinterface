...
import { TokenStorage, AuthenticationService, GlobalEventsManager, GenericService } from './services';
...
export class AppMenuComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.model = JSON.parse(this.tokenStorage.getMenus());
    console.info('My model ..... ');
    ...
    //       { label: this.lang === 'fr' ? 'Assigner Role' : 'Assign Role', icon: 'fa fa-plus', routerLink: ['/admin/userRoleAssignment'] },
    //       { label: this.lang === 'fr' ? 'Assigner Resource' : 'Assign Resource', icon: 'fa fa-plus', routerLink: ['/admin/roleResourceAssignment'] },
    //     ]
    //   },
    //   {
