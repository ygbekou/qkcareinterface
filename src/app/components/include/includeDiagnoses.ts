...
@Component({
  selector: 'app-includeDiagnoses',
  templateUrl: '../../pages/include/includeDiagnoses.html',
  providers: [GenericService, AdmissionService, DiagnosisDropdown]

})
export class IncludeDiagnoses extends BaseComponent implements OnInit, OnDestroy {
