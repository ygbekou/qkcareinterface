             ...
             <div class="ui-grid-row">
                <div class="ui-grid-col-11 ui-sm-12" >
                  <p-checkbox id="status" 
                    [(ngModel)]="patient.selectedMedicalHistories" [value]="medicalHistory.id"
...
export class MedicalHistoryDetails extends BaseComponent  implements OnInit, OnDestroy {
  ...
  getMedicalHistories() {
    ...
    this.visitService.getPatientEntities(this.patient.id, 'medicalHistories')
      .subscribe((data: Patient) => {
        this.patient = data;
      },
      error => console.log(error),
      () => console.log('Get all patient medical histories complete'));
